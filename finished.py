...
def reset_items():
    # Destroy all item frames and clear the lists of entry fields
...
# Create a button to reset items
reset_button = tk.Button(window, text="Reset", command=reset_items)
reset_button.pack()
